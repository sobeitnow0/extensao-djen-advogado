...
Responda EXATAMENTE neste formato JSON (sem markdown, sem blocos de código):
{
  ...
  "urgente": <true|false>,
  "comarca_cidade": "<Nome da cidade/município da comarca identificado na intimação, ex: 'Campinas' ou 'Não informada'>",
  "uf_comarca": "<UF do estado de 2 letras da comarca, ex: 'SP' ou 'Não informada'>",
  "alerta_stj_tempestividade": "<Oriente a juntar certidão se houver feriado local ou portaria atípica de suspensão>",
